...
class CollectiveMissionsAssets: 
	...
	# description 
	I_CM_SWITCH = RuleImage(roi_front=(414,478,43,58), roi_back=(310,453,282,114), threshold=0.78, method="Template matching", file="./tasks/CollectiveMissions/cm/cm_cm_switch.png")
	# 领取奖励 
